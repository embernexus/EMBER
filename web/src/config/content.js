...
export const ROADMAP_PHASES = [
  {
    ...
    items: [
      ...
      "Initial buy mode controls (SOL/tokens, including zero buy-in warning)",
      "Deploy results with mint, transaction, and Pump.fun link output",
      "Optional deploy auto-attach to Nexus in paused mode by default",
      "Pump.fun integration and multi-platform readiness",
    ],
  },
  {
    ...
    text: "#ffbc74",
    items: [
      "Volume bot deployment for supported EMBER markets",
      "Market maker bot rollout for deeper liquidity",
      "Execution reliability hardening for burn cycles",
      "Deploy pipeline hardening and launch observability",
  ...
  },
  {
    ...
    items: [
      ...
      "Volume bot suite expansion",
      "Market maker bot deployment",
      "Documentation and education hub",
      "Cross-chain expansion research (ETH, BSC)",
  ...
  },
  {
    ...
    items: [
      ...
      "Institutional automation features",
      "Multi-chain liquidity aggregation",
      "SDK and API access for third-party builders",
    ],
  },
];
...
export const DEV_LOGS = [
  {
    ...
    date: "March 4, 2026",
    channel: "Production",
    title: "Deploy Modal + Nexus Navigation Refresh",
    summary: "Launch flow now supports direct deploy access and cleaner account routing.",
    changes: [
      "Deploy modal opens for guests and keeps premium EMBER styling.",
      "Nexus nav button appears when signed in and routes directly to dashboard.",
      "Pump.fun icon and external link added to Buy $EMBER CTA.",
    ],
  },
  {
    version: "v0.9.3",
    date: "March 3, 2026",
    channel: "Production",
    title: "Burn Tracker Visual Upgrade",
    summary: "Burn analytics presentation was rebuilt for readability and tighter structure.",
    changes: [
      "Improved chart + token distribution layout and labeling.",
      "Burn history table pagination aligned for stable large datasets.",
      "Updated tracker copy to match protocol terminology.",
    ],
  },
  {
    version: "v0.9.2",
    date: "March 2, 2026",
    channel: "Production",
    title: "Protocol Metrics Alignment",
    summary: "Homepage + stats surfaces now align to unified public metric shape.",
    changes: [
      "Metric labels normalized for bot transaction scope.",
      "Public metrics fallback handling tightened for empty launch data.",
      "Homepage metrics hierarchy refined for clearer scan order.",
    ],
  },
  {
    version: "v0.9.1",
    date: "March 1, 2026",
    channel: "Production",
    title: "Roadmap + Whitepaper Rewording",
    summary: "Messaging updated to position EMBER as a multi-bot execution protocol.",
    changes: [
      "Advanced execution bots language applied across core pages.",
      "Fee model language clarified as current-state only.",
      "Architecture and lifecycle sections tightened for launch readability.",
    ],
  },
];
